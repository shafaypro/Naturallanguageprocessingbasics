...
and affix you can put on a word. Having individual
dictionary entries per version would be highly redundant and inefficient, especially since, once we convert to numbers,
the "value" is going to be identical.
...
def main():
    ...
    stem_sentence(new_text)
    # Calling the function stem sentence to pass it to the Stemmer and then print all the steams of the words.
