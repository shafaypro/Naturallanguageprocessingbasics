...
def stop_words_exclude(sentences=''):
    ...
    filtered_sentences = [w for w in word_tokens if w not in stop_words]  # this is the list of the filtered sentence
...
def main():
    example_sentences = "Hello Mr. Smith, how are you doing today? The weather is great, and Python is awesome. " \
