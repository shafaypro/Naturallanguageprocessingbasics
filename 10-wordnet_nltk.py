...
print(syns[0].lemmas()[
          0].name())
# This First Lematize the Sysns and then parse that to the name , to get the only name for the aLemmas
# To check the Definition for hte syns.
print(syns[0].definition())
# To check the Examples , for the particular sentence is like
print(syns[0].examples())
# examples of the sysset in the examples.
'''
